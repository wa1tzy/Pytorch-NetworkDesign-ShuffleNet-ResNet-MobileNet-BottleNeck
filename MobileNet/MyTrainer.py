...
from MobileNet.MyNet import MyNet
...
class Trainer:
    ...
    def train(self):
        if os.path.exists("../models/mobilenet.pth"):
            self.net = torch.load("../models/mobilenet.pth")
            print("exists")
        BATCH_SIZE = 76
        NUM_EPOCHS = 10
