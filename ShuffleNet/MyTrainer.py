...
from ShuffleNet.MyNet import MyNet
...
class Trainer:
    ...
    def train(self):
        if os.path.exists("../models/shufflenet.pth"):
            self.net = torch.load("../models/shufflenet.pth")
            print("exists")
        BATCH_SIZE = 70
        NUM_EPOCHS = 10
